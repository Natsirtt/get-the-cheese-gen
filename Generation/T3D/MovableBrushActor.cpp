...
MovableBrushActor::MovableBrushActor(Vector location, std::vector<std::vector<Vector>> polyList, bool sub) : mLocation{location}, mPolyList{polyList}, mSub{sub} {
}

MovableBrushActor::MovableBrushActor(double xLocation, double yLocation, double zLocation, std::vector<std::vector<Vector>> polyList, bool sub) : mLocation{Vector(xLocation, yLocation, zLocation)}, mPolyList{polyList}, mSub{sub} {
}

MovableBrushActor::MovableBrushActor(Grid *g) : IActor(g), mSub{false} {}
...
std::string MovableBrushActor::getT3D(int indentLevel, NameFactory *nameFactory) {
    ...
    stream << indentation << "Begin Actor Class=TERMovableBrush Name=" << actorName << " Archetype=TERMovableBrush'ter.Default__TERMovableBrush'" << std::endl;
    ...
    stream << indentation << "   Begin Object Class=TERBrushComponent Name=BrushComponent0 ObjName=" << componentName << " Archetype=TERBrushComponent'ter.Default__Brush:BrushComponent0'" << std::endl;
    ...
    stream << indentation << "      ObjectArchetype=TERBrushComponent'ter.Default__Brush:BrushComponent0'" << std::endl;
    ...
    stream << indentation << "   Tag=\"TERMovableBrush\"" << std::endl;
    stream << indentation << "   CollisionComponent=BrushComponent'" << componentName << "'" << std::endl;
    stream << indentation << "   Name=\"" << actorName << "\"" << std::endl;
    stream << indentation << "   ObjectArchetype=TERMovableBrush'ter.Default__TERMovableBrush'" << std::endl;
